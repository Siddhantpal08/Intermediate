...
function Header() {
    return (
        <header className='shadow sticky z-50 top-0'>
            <nav className= 'px-4 bg-white border-gray-200 lg:px-6 py-2.5'>
                <div className='flex flex-wrap justify-between items-center mx-auto max-w-screen-xl'>
                    ...
                    <Link to="#" className="text-gray-800 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium 
